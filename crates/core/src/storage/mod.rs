...
pub use manager::{
    ...
    get_global_env_vars, get_global_skills, get_language, get_onboarded_status,
    get_project_agents, get_project_skills, get_projects, get_skipped_version, get_templates,
    get_theme, get_project_column_align, get_update_check_interval, set_project_column_align,
    set_update_check_interval, get_floating_sidebar_enabled, set_floating_sidebar_enabled,
    get_floating_sidebar_position, set_floating_sidebar_position, import_cli_tool, import_global_doc_to_project,
