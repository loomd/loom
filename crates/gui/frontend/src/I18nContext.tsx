...
const zhDict: Dictionary = {
  ...
  'temp.modal.cmdOverridePlaceholder': '例如：gemini1（设置后可用 climaster gemini1 运行）',
  ...
  // SettingsPage
  'settings.title': '系统设置',
  'settings.subtitle': '配置 CliMaster 的全局参数和界面外观。',
...
const enDict: Dictionary = {
  ...
  'temp.modal.cmdOverridePlaceholder': 'e.g. gemini1 (allows running via climaster gemini1)',
  ...
  'settings.subtitle': 'Configure CliMaster global parameters and appearance.',
